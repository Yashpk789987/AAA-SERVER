...
INSERT INTO `questions` (`_id`,`sub_category_id`,`english_text`,`hindi_text`,`correct_option_index`,`pic`) VALUES 
...
CREATE TABLE `test` (
  ...
  `hindi_text` varchar(1000) default NULL,
  `time_allowed` varchar(45) default NULL,
  `cancel_allowed_time` varchar(45) default NULL,
